...
const IntroModal = () => {
  ...
  return (
    <Modal
      className="fixed left-1/2 top-1/2 z-[2147483647] flex h-2/3 w-2/3 -translate-x-1/2 -translate-y-1/2 transform flex-col items-center justify-center gap-12 rounded-3xl bg-white shadow-lg"
      isOpen={isModalOpen}
      ariaHideApp={false}
